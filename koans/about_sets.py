...
class AboutSets(Koan):
    ...
    def test_dictionaries_and_sets_use_same_curly_braces(self):
        ...
        self.assertEqual('set', {1, 2, 3}.__class__.__name__)
        self.assertEqual('dict', {'one': 1, 'two': 2}.__class__.__name__)

        self.assertEqual('dict', {}.__class__.__name__)

    def test_creating_sets_using_strings(self):
        self.assertEqual({'12345'}, {'12345'})
        self.assertEqual({'5','1','2','4','3'}, set('12345'))
